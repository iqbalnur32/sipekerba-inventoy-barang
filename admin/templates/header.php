  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="index.php" class="brand-link">
        <img src="../assets/dist/img/cmnp.png" alt="IT Helpdesk" class="brand-image elevation-3" style="opacity: .8">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <a class="d-block" style="cursor: default; margin-top:-12px;"><?= $_SESSION["login"]["name"] ?></a>
