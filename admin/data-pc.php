                    ...
                    <table class="table table-hover table-bordered" id="table_user" width="100%">
                        ...
                        <?php $no = 1; foreach ($data as $key): ?>
                            <tr>
                                ...
                                <td><?= $key['nama'] ?></td>
                                <td><?= $key['divisi'] ?></td>
                                <td><?= $key['Motherboard'] == 1 ? $key['namakategori'].' | '.$key['tipe'] : NULL ?></td>
                                <td><?= $key['Processor']   == 1 ? $key['namakategori'].' | '.$key['tipe'] : NULL ?></td>
                                <td><?= $key['HarDisk']     == 1 ? $key['namakategori'].' | '.$key['tipe'] : NULL ?></td>
                                <td><?= $key['Memory']      == 1 ? $key['namakategori'].' | '.$key['tipe'] : NULL ?></td>
                                <td><?= $key['namamerk'] ?></td>
                                <td><?= $key['namapc'] ?></td>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                          Apakah Anda Yakin Menghapus Data <b> <?= $key['nama'] ?></b> ?
                                        </div>
